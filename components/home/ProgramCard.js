...
const ProgramCard = ({ vname, ename }) => {
  return (
    <div className="max-w-[350px] bg-white  rounded-lg shadow-lg cursor-pointer md:h-[22rem] text-xs group/item drop-shadow-md hover:drop-shadow-2xl hover:scale-105 transform transition duration-500 ">
      <div>
