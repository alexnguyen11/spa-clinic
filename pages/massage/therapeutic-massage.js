...
const THERAPEUTIC = () => {
  return (
    <div>
      <MassageService
        massageName={therapeutic.massageName}
        imagePath={therapeutic.imagePath}
        massageTitle={therapeutic.massageTitle}
        massageDetails={therapeutic.massageDetails}
        customizeTitle={therapeutic.customizeTitle}
        customizeDetails={therapeutic.customizeDetails}
        benefitTitle={therapeutic.benefitTitle}
        benefitDetails={therapeutic.benefitDetails}
      />
    </div>
  );
};
